# Generated by Django 2.2.16 on 2021-02-17 16:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.BooleanField(default=False, verbose_name='картинка справа?')),
            ],
        ),
        migrations.CreateModel(
            name='Header',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(upload_to='image/', verbose_name='имя иконки(вместе с расширением)')),
            ],
        ),
    ]
