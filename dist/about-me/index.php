...
<html lang="en">
  <head>
    ...
    <title>Обо мне | Шпаргалка для лучшей жизни</title>
  ...
  <link href="../about-me/about-me.bundle.css" rel="stylesheet"></head>
  <body>
...
$email_link = 'mailto:'.$email;?><a class="contacts__card contacts__card_extra col aife" href="<?= $tel_link ?>" id="contact_phone">
  ...
  <script src="../about-me/about-me.bundle.js"></script></body>
</html>