...
<html lang="en">
  <head>
    ...
    <title>Покупка, <?= $product->props->title ?> | Шпаргалка для лучшей жизни</title>
  ...
  <link href="../buy/buy.bundle.css" rel="stylesheet"></head>
  <body>
    ...
    <div class="devicer mA">
      <center class="title ff-ars-b title_page">Покупка: <?= $product->props->title ?></center>
      <div class="products mA wfc"><?php
...
<?php else : ?>
          ...
          <button class="button rel cup button_pay">
            <div class="button__inflation button__inflation_1 abs"></div>
            <div class="button__inflation button__inflation_2 abs"></div>
            <div class="button__inflation button__inflation_3 abs"></div>
            <div class="button__inflation button__inflation_4 abs"></div>
            <div class="button__inflation button__inflation_5 abs"></div>
            <div class="button__inflation button__inflation_6 abs"></div><span>Оплатить</span><br><strong>55 000 руб</strong>
          </button></a>
      </div>
    </div>
  ...
  <script src="../buy/buy.bundle.js"></script></body>
</html>