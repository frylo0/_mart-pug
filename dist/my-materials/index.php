...
<html lang="en">
  <head>
    ...
    <title>Мои материалы | Шпаргалка для лучшей жизни</title>
  ...
  <link href="../my-materials/my-materials.bundle.css" rel="stylesheet"></head>
  <body>
    ...
    <div class="devicer mA">
      <center class="title ff-ars-b">Мои материалы</center>
      <div class="office_subtitle"> </div>
      <div class="office_articles row wrap jcsb"><?php
...
<?php $product = $db->at_path('pages/shop/product1'); ?>
  ...
  <script src="../my-materials/my-materials.bundle.js"></script></body>
</html>