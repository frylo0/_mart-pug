...
<html lang="en">
  ...
  <link href="../home/home.bundle.css" rel="stylesheet"></head>
  <body>
    ...
    <div class="devicer mA">
      <?php
$sections = $db->at_id(54)->get_children();?><?php foreach ($sections as $section) : ?>
<?php $is_main_hide_title = true; ?>
<?php $is_read_more = true; ?>
<?php $is_arrows = true; ?>
<?php $is_sales = true; ?>
...
$email_link = 'mailto:'.$email;?><a class="contacts__card contacts__card_extra col aife" href="<?= $tel_link ?>" id="contact_phone">
  ...
  <script src="../home/home.bundle.js"></script></body>
</html>