...
<html lang="en">
  <head>
    ...
    <title>Акции | Шпаргалка для лучшей жизни</title>
  ...
  <link href="../sales/sales.bundle.css" rel="stylesheet"></head>
  <body>
    ...
    <div class="devicer mA">
      <center class="title ff-ars-b title_page">Акции</center>
      <div class="row selects jcc">
...
<?php endforeach; ?>
      ...
      <div class="products row wrap jcc"><?php
...
<?php else : ?>
        ...
        <div class="page-blocks_1-2">
          <div class="page-block row aic page-block_full-width page-block_blog"><a class="page-block__title" href="../blog">БЛОГ</a><img class="page-block__icon" src="../__attach/Images/icon_blog.svg">
            <div class="page-block__content">
              <div class="row"><a href="../product">Как не позволять людям влиять на нас</a><a href="../product">Не играйте мне на нервах или как научиться противостоять третированию</a></div>
            </div>
          </div>
          <div class="page-block row aic page-block_full-width page-block_consult"><a class="page-block__title" href="../consult">КОНСУЛЬТАЦИИ</a><img class="page-block__icon" src="../__attach/Images/icon_promotion.svg">
            <div class="page-block__content">
              <div class="row">
                <div class="row page-block_consult__directions"><a class="col aic" href="../product"><img src="../__attach/Images/pink_mentor.svg"><span>Разовые</span></a><a class="col aic" href="../product"><img src="../__attach/Images/pink_meeting.svg"><span>Серийные</span></a><a class="col aic" href="../product"><img src="../__attach/Images/pink_networking.svg"><span>Семейные</span></a>
                </div>
                <div class="col page-block_consult__top jcc"><a href="../product">Ассоциативная шпаргалка</a><a href="../product">Нумерологический рассчет женихов</a></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="../sales/sales.bundle.js"></script></body>
</html>